    ...
    >
      ...
      <div className="flex items-start justify-between gap-2">
        ...
        <div>
          ...
          <h3 className="font-semibold text-theme">{task.candidateName}</h3>

          <p className="mt-0.5 text-sm text-theme-muted">{task.positionTitle}</p>
      ...
      <div className="mt-3 flex flex-wrap items-center gap-2 text-xs text-theme-muted">
        ...
        <span className="rounded-full bg-[var(--color-surface)] px-2 py-0.5 text-theme-subtle">
