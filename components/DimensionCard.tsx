    ...
    <div className="kit-card p-4">
      ...
      <div className="mb-3 flex items-start justify-between">
        ...
        <div>
          ...
          <h3 className="font-semibold text-theme">{meta.label}</h3>

          <p className="mt-0.5 text-xs text-theme-muted">{meta.description}</p>
        ...
        <div className="flex items-center gap-2">
          ...
          {!readonly && onOverride && (
            ...
            <button
              ...
              className="rounded-full px-2.5 py-1 text-xs text-violet-500 hover:bg-violet-500/10 dark:text-violet-400"
      ...
      <div className="mb-3 h-1.5 overflow-hidden rounded-full bg-[var(--color-surface)]">
      ...
      <ul className="space-y-1.5">
        ...
        {evidence.map((e, i) => (
          ...
          <li key={i} className="flex gap-2 text-sm text-theme-muted">
            ...
            <span className="mt-1.5 h-1 w-1 shrink-0 rounded-full bg-violet-500 dark:bg-violet-400" />
